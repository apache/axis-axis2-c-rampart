                          ...
                          axis2_char_t *value)
{
    ...
    x509_cert->subject = (axis2_char_t *)axis2_strdup(env, value);
    return AXIS2_SUCCESS;
}
AXIS2_EXTERN axis2_status_t AXIS2_CALL
                         ...
                         axis2_char_t *value)
{
    ...
    x509_cert->issuer = (axis2_char_t *)axis2_strdup(env, value);
    return AXIS2_SUCCESS;
}
AXIS2_EXTERN axis2_status_t AXIS2_CALL
                                 ...
                                 axis2_char_t *value)
{
    ...
    x509_cert->key_identifier = (axis2_char_t *)axis2_strdup(env, value);
    return AXIS2_SUCCESS;
}
                              ...
                              axis2_char_t *value)
{
    ...
    x509_cert->fingerprint = (axis2_char_t *)axis2_strdup(env, value);
    return AXIS2_SUCCESS;
}
AXIS2_EXTERN axis2_status_t AXIS2_CALL
                       ...
                       axis2_char_t *value)
{
    ...
    x509_cert->date = (axis2_char_t *)axis2_strdup(env, value);
    return AXIS2_SUCCESS;
}
AXIS2_EXTERN axis2_status_t AXIS2_CALL
                       ...
                       axis2_char_t *value)
{
    ...
    x509_cert->hash = (axis2_char_t *)axis2_strdup(env, value);
    return AXIS2_SUCCESS;
}
AXIS2_EXTERN axis2_status_t AXIS2_CALL
                       ...
                       axis2_char_t *value)
{
    ...
    x509_cert->data = (axis2_char_t *)axis2_strdup(env, value);
    return AXIS2_SUCCESS;
}
AXIS2_EXTERN axis2_status_t AXIS2_CALL
